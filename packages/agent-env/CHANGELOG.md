...
- [#117](https://github.com/zookanalytics/bmad-orchestrator/pull/117) [`3391f7a`](https://github.com/zookanalytics/bmad-orchestrator/commit/3391f7a47b1c25122bf6925e62a8cc8acb57ede3) Thanks [@johnzook](https://github.com/johnzook)! - Pin Docker image tag to agent-env version.
...
- [#114](https://github.com/zookanalytics/bmad-orchestrator/pull/114) [`95f48f9`](https://github.com/zookanalytics/bmad-orchestrator/commit/95f48f9a6a2aedba4966c38c8be90fd3df95803c) Thanks [@zook-bot](https://github.com/zook-bot)! - Fix `agent-env create` on Linux / Podman hosts (previously macOS + Docker Desktop only):
